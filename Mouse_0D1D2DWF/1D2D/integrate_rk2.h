...
void integrate_rk2( void (*f)( double , double , double *, double * , double * , pars_rec * , double * ), double * tspan, int sy0, double * y0, double dt, double * pin , pars_rec * pars1 , double * allDrugs );
...
void integrate_rk2( void (*f)( double , double , double *, double *, double * , pars_rec * , double * ), double * tspan, int sy0, double * y0, double dt, double * pin , pars_rec * pars1 , double * allDrugs ){
	...
	f( dt, t, y1, pin, ydot , pars1 , allDrugs );
	...
	f( dt, t, y2, pin, ydot , pars1 , allDrugs );
