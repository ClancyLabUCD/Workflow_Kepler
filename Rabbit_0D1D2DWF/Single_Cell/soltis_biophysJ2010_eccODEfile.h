...
void soltis_biophysJ2010_eccODEfile( double dt, double tt, double * y, double * p, double * ydot  , pars_rec * pars1 , double * allDrugs ){
	...
	double pNaK = 0.01833;
	double GtoSlow = 0.06*1.3+ factor_Ito;   // [mS/uF]
	double GtoFast = 0.02*1.3+ factor_Ito;   // [mS/uF]
	double gkp = 0.001;
    ...
    const double gkr =  0.035 * sqrt( Ko / 5.4 ) * factor_flec * 6 * BlockGkr;
