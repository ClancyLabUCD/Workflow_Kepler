...
void integrate_rk2( void (*f)( double , double , double *, double * , double * , pars_rec * , double * drug ), double * tspan, int sy0, double * y0, double dt, double * pin , pars_rec * pars1 , double * drug );
